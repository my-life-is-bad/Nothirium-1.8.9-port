...
public class ChunkRendererGL15Optifine extends ChunkRendererGL15 {
	...
	protected void setupClientState(ChunkRenderPass pass) {
		...
		if (Optifine.IS_SHADERS.invoke(null)) {
			Optifine.PRE_RENDER_CHUNK_LAYER.invoke(null, EnumWorldBlockLayerUtil.getEnumWorldBlockLayer(pass));
		}
	}
	...
	protected void resetClientState(ChunkRenderPass pass) {
		if (Optifine.IS_SHADERS.invoke(null)) {
			Optifine.POST_RENDER_CHUNK_LAYER.invoke(null, EnumWorldBlockLayerUtil.getEnumWorldBlockLayer(pass));
		}
